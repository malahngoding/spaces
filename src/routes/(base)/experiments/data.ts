export const breadAndButter = [
	{
		link: '/experiments/mensimulasikan-internet-lambat-dengan-chrome-developer-tools',
		image:
		...
		excerpt: 'Uji coba bagaimana kelakuan web kamu ketika internet sedang lambat'
	},
	{
		link: '/experiments/mengurutkan-array-dari-objects-berdasarkan-nilai-dari-property-nya-pada-javascript',
		image:
		...
		excerpt:
			'Bayangkan kamu memiliki array dari objek Javascript, bagaimana cara mengurutkannya berdasarkan nilai salah satu dari propertinya'
	},
	{
		link: '/experiments/menunjukan-sejauh-mana-scroll-user-dengan-javascript',
		image:
		...
		excerpt: 'Sudah sejauh apa user melakukan scrolling pada halaman web kamu?'
	},
	{
		link: '/experiments/memberikan-styling-pada-consolelog-kalian',
		image:
		...
		excerpt: 'Membuat console kalian lebih bergaya dengan kostumisasi'
	}
];
